...
func initConfConfiguration() {
	...
	conf.AddPole("Configuration", "Configuration", "Configuration.Name", "StringValue", NULL, "None", &PoleCheckerStringValue{}, true, true, "Имя конфигурации")
	conf.AddPole("Configuration", "Configuration", "Configuration.Type", "StringValue", NULL, "None", &PoleCheckerStringValue{List: map[string]bool{"PoleInfo": true, "DocumentType": true, "Depend": true}}, true, true, "Тип конфигурируемого элемента")
	conf.AddPole("Configuration", "Configuration", "Configuration.Title", "StringValue", NULL, "None", &PoleCheckerStringValue{}, true, true, "Описание элемента")
	conf.AddPole("Configuration", "Configuration", "Configuration.Depend.ConfigurationName", "StringValue", NULL, "None", &PoleCheckerStringValue{}, true, true, "Ссылка на конфигурацию")
	...
	conf.AddPole("Configuration", "Configuration", "Configuration.DocumentType.Name", "StringValue", NULL, "None", &PoleCheckerStringValue{}, true, true, "Описание типа документа. Имя типа")
	...
	conf.AddPole("Configuration", "Configuration", "Configuration.PoleInfo.CheckerInt64ValueMin", "Int64Value", NULL, "None", &PoleCheckerInt64Value{}, true, true, "Описание поля. Проверка Int Min")
	conf.AddPole("Configuration", "Configuration", "Configuration.PoleInfo.CheckerInt64ValueMax", "Int64Value", NULL, "None", &PoleCheckerInt64Value{}, true, true, "Описание поля. Проверка Int Max")
	conf.AddPole("Configuration", "Configuration", "Configuration.PoleInfo.CheckerInt64ValueList", "StringValue", NULL, "None", &PoleCheckerStringValue{}, true, true, "Описание поля. Проверка Int список доступных значений")
	conf.AddPole("Configuration", "Configuration", "Configuration.PoleInfo.CheckerStringValueList", "StringValue", NULL, "None", &PoleCheckerStringValue{}, true, true, "Описание поля. Проверка String список доступных значений")
	conf.AddPole("Configuration", "Configuration", "Configuration.PoleInfo.CheckerStringValueAllowNull", "StringValue", NULL, "None", &PoleCheckerStringValue{List: map[string]bool{"True": true, "False": true}}, true, true, "Описание поля. Может равнятся NULL")
...
func initDocumentConfiguration() {
	...
	conf.AddPole("Document", "Document", "Document.DocumentType", "StringValue", NULL, "Index", &PoleCheckerStringValue{}, true, true, "Тип документа")

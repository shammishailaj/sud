...
func initConfConfiguration() {
	...
	conf.AddPole("Configuration", "Configuration", "Configuration.Type", "StringValue", corebase.NULL, "None", &PoleCheckerStringValue{List: map[string]bool{"PoleInfo": true, "RecordType": true, "Depend": true}}, true, true, "Тип конфигурируемого элемента")
	...
	conf.AddPole("Configuration", "Configuration", "Configuration.RecordType.Name", "StringValue", corebase.NULL, "None", &PoleCheckerStringValue{}, true, true, "Описание типа документа. Имя типа")
	conf.AddPole("Configuration", "Configuration", "Configuration.RecordType.New", "StringValue", "True", "None", &PoleCheckerStringValue{List: map[string]bool{"True": true, "False": true}}, true, true, "Описание типа документа. Разрешено создание таких документов")
	conf.AddPole("Configuration", "Configuration", "Configuration.RecordType.Read", "StringValue", "True", "None", &PoleCheckerStringValue{List: map[string]bool{"True": true, "False": true}}, true, true, "Описание типа документа. Разрешено чтение таких документов")
	conf.AddPole("Configuration", "Configuration", "Configuration.RecordType.Save", "StringValue", "True", "None", &PoleCheckerStringValue{List: map[string]bool{"True": true, "False": true}}, true, true, "Описание типа документа. Разрешено  сохранение таких документов")
	conf.AddPole("Configuration", "Configuration", "Configuration.PoleInfo.RecordType", "StringValue", "True", "None", &PoleCheckerStringValue{}, true, true, "Описание поля. Тип документа")
	conf.AddPole("Configuration", "Configuration", "Configuration.PoleInfo.PoleType", "StringValue", "True", "None", &PoleCheckerStringValue{List: map[string]bool{"StringValue": true, "Int32Value": true, "DateTimeValue": true, "DateValue": true, "RecordLinkValue": true}}, true, true, "Описание поля. Тип поля")
...
func initRecordConfiguration() {
	conf := NewConfiguration()
	conf.AddType("Record", "Record", true, true, true, "Документ")
	conf.AddPole("Record", "Record", "Record.RecordType", "StringValue", corebase.NULL, "Index", &PoleCheckerStringValue{}, true, true, "Тип документа")
	InitAddBaseConfiguration("Record", conf)
}
